...
export const api = {
  ...
  getLogs: (p: { page?: number; per_page?: number; search?: string; device?: string; date?: string; date_from?: string; date_to?: string; direction?: string; role?: string; time_from?: string; time_to?: string }) =>
